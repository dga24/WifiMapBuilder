            ...
            mBroadcastReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context c, Intent intent) {
                    ...
                    for (ScanResult scanResult : wifiList) {
                        ...
                        MuestraCapturada m= createMuestra(scanResult,mSamples,mrep);
                        lstMuestraCap.add(m);
                        numMuestra++;
                        ssid =scanResult.SSID;
                        Log.d("WifiManager:    ", "MAC: " + scanResult.BSSID + "  SSID: " + scanResult.SSID + "" + "  POTENCIA[dBm]: " + scanResult.level
                                + "Timestamp: " + String.valueOf(timestamp)+"   mSamples: "+ (numMuestra-1)+"  numMuestra: "+mSamples);
                    }
